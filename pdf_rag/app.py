...
from model import load_gemini  # Importing the LLM model from model.py

# LangChain & AI Imports
from src.helper import download_huggingface_model, process_documents
...
db_docsearch = PineconeVectorStore.from_existing_index(index_name="pmajay", embedding=embeddings)
...
def upload_pdf():
    ...
    if file and allowed_file(file.filename):
        ...
        # Create Vector Store & Chain
        pdf_docsearch = process_documents(filepath, embeddings)
